...
const showProjectDetailsPage = async (req, res, next) => {
    try {
        ...
        if (user) {
            isVolunteered = await isUserVolunteered(projectId, user.user_id);
        }
...
export { showEditProjectForm, processEditProjectForm,projectValidation,showProjectsPage, showProjectDetailsPage, processNewProjectForm, showNewProjectForm };